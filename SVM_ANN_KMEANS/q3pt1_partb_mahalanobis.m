...
[clst_mn_3, clst_cnt_3, cnt_1, clst_n1] = kmeans_mahaln(train_data, c1);
[clst_mn_4, clst_cnt_4, cnt_2, clst_n2] = kmeans_mahaln(train_data, c2);
[clst_mn_5, clst_cnt_5, cnt_3, clst_n3] = kmeans_mahaln(train_data, c3);
